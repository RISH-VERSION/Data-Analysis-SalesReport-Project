...
filename = "business_insights_and_report.pdf"
...
story.append(Image("../year+month_full_time_time_superstore.png", width=400, height=300))
story.append(Spacer(1, 12))
...
story.append(Image("../Top_sales_per_customer.png", width=400, height=300))
story.append(Image("../Top_Profits_Per_customer.png", width=400, height=300))
story.append(Spacer(1, 12))
story.append(Paragraph("Explanation", styles["Heading3"]))
...
story.append(Image("../Top_10products.png", width=400, height=300))
story.append(Spacer(1, 12))
story.append(Paragraph("Explanation", styles["Heading3"]))
...
story.append(Image("../Sales_By_Region_Bar.png", width=400, height=300))
story.append(Image("../Sales_By_Region_Pie.png", width=400, height=300))
story.append(Spacer(1, 12))
story.append(Paragraph("Explanation", styles["Heading3"]))
